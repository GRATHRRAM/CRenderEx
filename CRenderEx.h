...
#define CR_FRED   (CR_Color){255,0,0,255} //Full Red
#define CR_FGREEN (CR_Color){0,255,0,255} //Full Green
#define CR_FBLUE  (CR_Color){0,0,255,255} //Full Blue

#define CR_WHITE (CR_Color){255,255,255,255} //White
#define CR_BLACK (CR_Color){0,0,0,255}   //Black
#define CR_VOID  (CR_Color){0,0,0,0}    //Its fully Transparent and its not drawn
